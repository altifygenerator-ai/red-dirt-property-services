...
export const servicePages: Record<string, ServicePageData> = {
  "property-cleanup": {
    ...
    description:
      "Red Dirt Property Services LLC handles property cleanup, brush cleanup, junk piles, debris hauling, neglected yards, and rural cleanup work around Amity, Glenwood, Mount Ida, Hot Springs, Arkadelphia, and nearby Arkansas towns.",
    ogTitle: "Property Cleanup in Rural Arkansas | Red Dirt Property Services LLC",
    ogDescription:
  ...
  "junk-removal": {
    ...
    ogTitle: "Junk Removal & Hauling | Red Dirt Property Services LLC",
    ogDescription:
  ...
  "shed-removal": {
    ...
    ogTitle: "Shed Removal & Small Structure Cleanup | Red Dirt Property Services LLC",
    ogDescription:
  ...
  "storm-cleanup": {
    ...
    ogTitle: "Storm Cleanup & Debris Hauling | Red Dirt Property Services LLC",
    ogDescription:
  ...
  "dirt-work": {
    ...
    description:
      "Red Dirt Property Services LLC handles small dirt work, driveway touch-ups, rough grading, drainage ditches, culvert help, washouts, and rural property work around Amity, Glenwood, Mount Ida, Hot Springs, Arkadelphia, and nearby Arkansas towns.",
  ...
  "tree-work": {
    ...
    description:
      "Red Dirt Property Services LLC handles small tree work, limb cleanup, brush removal, light clearing, small acreage cleanup, and tree debris hauling around Amity, Glenwood, Mount Ida, Hot Springs, Arkadelphia, and nearby Arkansas towns. Tree work depends on the job and location.",
  ...
  "stump-grinding": {
    ...
    description:
      "Red Dirt Property Services LLC handles stump grinding for yards, driveways, fence lines, cleanup areas, and rural properties around Amity, Glenwood, Mount Ida, Hot Springs, Arkadelphia, and nearby Arkansas towns.",
    ogTitle: "Stump Grinding | Red Dirt Property Services LLC",
    ogDescription:
  ...
  "hot-springs-junk-removal": {
    ...
    ogTitle: "Hot Springs Junk Removal & Hauling | Red Dirt Property Services LLC",
    ogDescription:
  ...
  "hot-springs-property-cleanup": {
    ...
    ogTitle: "Hot Springs Property Cleanup | Red Dirt Property Services LLC",
    ogDescription:
  ...
  "hot-springs-stump-grinding": {
    ...
    ogTitle: "Hot Springs Stump Grinding | Red Dirt Property Services LLC",
    ogDescription:
  ...
  "glenwood-junk-removal": {
    slug: "glenwood-junk-removal",
    title: "Junk Removal in Glenwood, AR",
    description: "Junk removal and haul-off in Glenwood, Arkansas for furniture, appliances, garage piles, rental debris, and rural property junk. Call Red Dirt for a local quote.",
    ogTitle: "Junk Removal in Glenwood, AR | Red Dirt Property Services LLC",
    ogDescription: "Junk removal and haul-off in Glenwood, Arkansas for furniture, appliances, garage piles, rental debris, and rural property junk. Call Red Dirt for a local quote.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "glenwood junk removal work by Red Dirt Property Services LLC",
    eyebrow: "Glenwood Junk Removal • Local Quotes • Red Dirt",
    h1: "Junk Removal In Glenwood Without The Runaround.",
    intro: "Glenwood homes, rentals, shops, and country properties often need more than curbside pickup. Red Dirt loads and hauls furniture, appliances, garage junk, renovation debris, and mixed property piles when the job fits our truck and trailers.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Glenwood Junk Removal",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Glenwood homes, rentals, shops, and country properties often need more than curbside pickup. Red Dirt loads and hauls furniture, appliances, garage junk, renovation debris, and mixed property piles when the job fits our truck and trailers.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Furniture and appliance haul-off", "Garage and shop cleanups", "Rental property junk", "Rural debris piles", "Small construction debris", "Multi-load cleanup jobs"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for glenwood junk removal jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "Around Glenwood, access can range from an easy driveway to a narrow lane or sloped country property. Photos of the pile and the route to it help us quote the labor, trailer space, disposal, and mileage without guessing.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Glenwood AR, Amity AR, Kirby AR, and nearby properties.",
    areaText: "This page is specifically for Glenwood, Arkansas and nearby communities including Amity AR, Kirby AR, Caddo Gap AR. Travel and disposal are included when we build the quote.",
    schemaName: "Glenwood Junk Removal",
    schemaDescription: "Junk removal and haul-off in Glenwood, Arkansas for furniture, appliances, garage piles, rental debris, and rural property junk. Call Red Dirt for a local quote.",
    serviceType: ["Furniture and appliance haul-off", "Garage and shop cleanups", "Rental property junk", "Rural debris piles", "Small construction debris", "Multi-load cleanup jobs"],
    areaServed: ["Glenwood AR", "Amity AR", "Kirby AR", "Caddo Gap AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Glenwood Services", "href": "/glenwood-ar", "text": "See the full range of property services available in the area."}],
  },
  "glenwood-property-cleanup": {
    slug: "glenwood-property-cleanup",
    title: "Property Cleanup in Glenwood, AR",
    description: "Property cleanup in Glenwood, Arkansas for brush, junk, storm debris, neglected yards, rentals, cabins, and rural acreage. Local quotes from Red Dirt.",
    ogTitle: "Property Cleanup in Glenwood, AR | Red Dirt Property Services LLC",
    ogDescription: "Property cleanup in Glenwood, Arkansas for brush, junk, storm debris, neglected yards, rentals, cabins, and rural acreage. Local quotes from Red Dirt.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "glenwood property cleanup work by Red Dirt Property Services LLC",
    eyebrow: "Glenwood Property Cleanup • Local Quotes • Red Dirt",
    h1: "Get A Rough Glenwood Property Back Under Control.",
    intro: "Property cleanup around Glenwood can mean brush along a fence, old materials behind a shop, junk around a rental, storm limbs near a cabin, or several problems spread across one piece of ground. We combine cleanup, cutting, loading, and hauling when practical.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Glenwood Property Cleanup",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Property cleanup around Glenwood can mean brush along a fence, old materials behind a shop, junk around a rental, storm limbs near a cabin, or several problems spread across one piece of ground. We combine cleanup, cutting, loading, and hauling when practical.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Whole-property cleanup", "Brush and limb piles", "Rental and cabin cleanup", "Fence-line clearing", "Storm debris removal", "Combined cutting and hauling"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for glenwood property cleanup jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "The best Glenwood cleanup quotes start with wide photos. Show the full work area, anything that must be hauled, gates or slopes, and whether equipment can reach the mess. That keeps the quote tied to the actual property.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Glenwood AR, Amity AR, Kirby AR, and nearby properties.",
    areaText: "This page is specifically for Glenwood, Arkansas and nearby communities including Amity AR, Kirby AR, Norman AR. Travel and disposal are included when we build the quote.",
    schemaName: "Glenwood Property Cleanup",
    schemaDescription: "Property cleanup in Glenwood, Arkansas for brush, junk, storm debris, neglected yards, rentals, cabins, and rural acreage. Local quotes from Red Dirt.",
    serviceType: ["Whole-property cleanup", "Brush and limb piles", "Rental and cabin cleanup", "Fence-line clearing", "Storm debris removal", "Combined cutting and hauling"],
    areaServed: ["Glenwood AR", "Amity AR", "Kirby AR", "Norman AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Glenwood Services", "href": "/glenwood-ar", "text": "See the full range of property services available in the area."}],
  },
  "glenwood-brush-hogging": {
    slug: "glenwood-brush-hogging",
    title: "Brush Hogging in Glenwood, AR",
    description: "Brush hogging and bush hogging in Glenwood, Arkansas for fields, trails, lot edges, overgrown acreage, and rural properties. Send photos for a quote.",
    ogTitle: "Brush Hogging in Glenwood, AR | Red Dirt Property Services LLC",
    ogDescription: "Brush hogging and bush hogging in Glenwood, Arkansas for fields, trails, lot edges, overgrown acreage, and rural properties. Send photos for a quote.",
    heroImage: "/images/tractor-bush-hog.jpg",
    heroAlt: "glenwood brush hogging work by Red Dirt Property Services LLC",
    eyebrow: "Glenwood Brush Hogging • Local Quotes • Red Dirt",
    h1: "Cut Back Overgrowth Around Glenwood.",
    intro: "Fields, trails, lots, and country places around Glenwood grow up fast. Red Dirt handles rough mowing and brush hogging for areas that are beyond a finish mower but still safe and practical for our equipment.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Glenwood Brush Hogging",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Fields, trails, lots, and country places around Glenwood grow up fast. Red Dirt handles rough mowing and brush hogging for areas that are beyond a finish mower but still safe and practical for our equipment.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Overgrown fields", "Trail and lane opening", "Fence-line mowing", "Lot and acreage cutting", "Cabin property brush work", "Cleanup after rough mowing"],
    detailImage: "/images/tractor-pov.jpg",
    detailAlt: "Red Dirt equipment used for glenwood brush hogging jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "Ground conditions matter as much as acreage. Rocks, wire, hidden debris, steep slopes, wet spots, and saplings can change the work. We ask for photos and an honest description before putting a number on it.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Glenwood AR, Amity AR, Kirby AR, and nearby properties.",
    areaText: "This page is specifically for Glenwood, Arkansas and nearby communities including Amity AR, Kirby AR, Norman AR. Travel and disposal are included when we build the quote.",
    schemaName: "Glenwood Brush Hogging",
    schemaDescription: "Brush hogging and bush hogging in Glenwood, Arkansas for fields, trails, lot edges, overgrown acreage, and rural properties. Send photos for a quote.",
    serviceType: ["Overgrown fields", "Trail and lane opening", "Fence-line mowing", "Lot and acreage cutting", "Cabin property brush work", "Cleanup after rough mowing"],
    areaServed: ["Glenwood AR", "Amity AR", "Kirby AR", "Norman AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Glenwood Services", "href": "/glenwood-ar", "text": "See the full range of property services available in the area."}],
  },
  "arkadelphia-junk-removal": {
    slug: "arkadelphia-junk-removal",
    title: "Junk Removal in Arkadelphia, AR",
    description: "Junk removal in Arkadelphia, Arkansas for rentals, homes, garages, furniture, appliances, move-outs, and property debris. Call or text Red Dirt for a quote.",
    ogTitle: "Junk Removal in Arkadelphia, AR | Red Dirt Property Services LLC",
    ogDescription: "Junk removal in Arkadelphia, Arkansas for rentals, homes, garages, furniture, appliances, move-outs, and property debris. Call or text Red Dirt for a quote.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "arkadelphia junk removal work by Red Dirt Property Services LLC",
    eyebrow: "Arkadelphia Junk Removal • Local Quotes • Red Dirt",
    h1: "Junk Removal For Arkadelphia Homes And Rentals.",
    intro: "Arkadelphia junk removal often comes from rental turnovers, college moves, inherited belongings, garage cleanups, and homeowners finally clearing a pile that has been sitting too long. Red Dirt quotes the load, labor, access, and disposal clearly.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Arkadelphia Junk Removal",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Arkadelphia junk removal often comes from rental turnovers, college moves, inherited belongings, garage cleanups, and homeowners finally clearing a pile that has been sitting too long. Red Dirt quotes the load, labor, access, and disposal clearly.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Rental turnover junk", "Furniture haul-off", "Appliance removal", "Garage cleanups", "Move-out debris", "Property junk piles"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for arkadelphia junk removal jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "Stairs, apartments, tight parking, heavy items, and mixed debris all affect the work. Send several photos and the Arkadelphia location so we can see what must be carried, loaded, and disposed of.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Arkadelphia AR, Caddo Valley AR, Bismarck AR, and nearby properties.",
    areaText: "This page is specifically for Arkadelphia, Arkansas and nearby communities including Caddo Valley AR, Bismarck AR, Gurdon AR. Travel and disposal are included when we build the quote.",
    schemaName: "Arkadelphia Junk Removal",
    schemaDescription: "Junk removal in Arkadelphia, Arkansas for rentals, homes, garages, furniture, appliances, move-outs, and property debris. Call or text Red Dirt for a quote.",
    serviceType: ["Rental turnover junk", "Furniture haul-off", "Appliance removal", "Garage cleanups", "Move-out debris", "Property junk piles"],
    areaServed: ["Arkadelphia AR", "Caddo Valley AR", "Bismarck AR", "Gurdon AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Arkadelphia Services", "href": "/arkadelphia-ar", "text": "See the full range of property services available in the area."}],
  },
  "arkadelphia-cleanouts": {
    slug: "arkadelphia-cleanouts",
    title: "Cleanouts in Arkadelphia, AR",
    description: "Rental, estate, garage, storage, and move-out cleanouts in Arkadelphia, Arkansas. Red Dirt handles loading and haul-off for practical local cleanup jobs.",
    ogTitle: "Cleanouts in Arkadelphia, AR | Red Dirt Property Services LLC",
    ogDescription: "Rental, estate, garage, storage, and move-out cleanouts in Arkadelphia, Arkansas. Red Dirt handles loading and haul-off for practical local cleanup jobs.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "arkadelphia cleanouts work by Red Dirt Property Services LLC",
    eyebrow: "Arkadelphia Cleanouts • Local Quotes • Red Dirt",
    h1: "Clear The Space And Move The Property Forward.",
    intro: "Cleanouts around Arkadelphia can involve rentals between tenants, family properties, garages, storage rooms, outbuildings, or a house being prepared for sale. We handle the physical loading and haul-off so the space can be used again.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Arkadelphia Cleanouts",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Cleanouts around Arkadelphia can involve rentals between tenants, family properties, garages, storage rooms, outbuildings, or a house being prepared for sale. We handle the physical loading and haul-off so the space can be used again.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Rental cleanouts", "Estate property cleanup", "Garage cleanouts", "Storage room clearing", "Move-out haul-off", "Outbuilding cleanouts"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for arkadelphia cleanouts jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "A cleanout quote depends on volume, weight, stairs, access, sorting, and how many trailer loads the job may take. Room-by-room photos are usually the fastest way to get an accurate starting quote.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Arkadelphia AR, Caddo Valley AR, Bismarck AR, and nearby properties.",
    areaText: "This page is specifically for Arkadelphia, Arkansas and nearby communities including Caddo Valley AR, Bismarck AR, Gurdon AR. Travel and disposal are included when we build the quote.",
    schemaName: "Arkadelphia Cleanouts",
    schemaDescription: "Rental, estate, garage, storage, and move-out cleanouts in Arkadelphia, Arkansas. Red Dirt handles loading and haul-off for practical local cleanup jobs.",
    serviceType: ["Rental cleanouts", "Estate property cleanup", "Garage cleanouts", "Storage room clearing", "Move-out haul-off", "Outbuilding cleanouts"],
    areaServed: ["Arkadelphia AR", "Caddo Valley AR", "Bismarck AR", "Gurdon AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Arkadelphia Services", "href": "/arkadelphia-ar", "text": "See the full range of property services available in the area."}],
  },
  "arkadelphia-property-cleanup": {
    slug: "arkadelphia-property-cleanup",
    title: "Property Cleanup in Arkadelphia, AR",
    description: "Property cleanup in Arkadelphia, Arkansas for junk, brush, rental debris, storm mess, neglected lots, and rural properties. Request a local Red Dirt quote.",
    ogTitle: "Property Cleanup in Arkadelphia, AR | Red Dirt Property Services LLC",
    ogDescription: "Property cleanup in Arkadelphia, Arkansas for junk, brush, rental debris, storm mess, neglected lots, and rural properties. Request a local Red Dirt quote.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "arkadelphia property cleanup work by Red Dirt Property Services LLC",
    eyebrow: "Arkadelphia Property Cleanup • Local Quotes • Red Dirt",
    h1: "Cleanup Help For Arkadelphia Properties That Need More Than Mowing.",
    intro: "Some Arkadelphia properties need several kinds of work at once: junk hauled from a rental, brush cut near a lot edge, limbs removed after weather, or old debris cleared before listing or repair work begins. Red Dirt handles practical cleanup projects that fit our crew and equipment.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Arkadelphia Property Cleanup",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Some Arkadelphia properties need several kinds of work at once: junk hauled from a rental, brush cut near a lot edge, limbs removed after weather, or old debris cleared before listing or repair work begins. Red Dirt handles practical cleanup projects that fit our crew and equipment.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Rental property cleanup", "Brush and debris removal", "Storm mess cleanup", "Vacant property clearing", "Rural lot cleanup", "Hauling and light demo"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for arkadelphia property cleanup jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "Tell us what the property needs to look like when the job is finished. Photos of each problem area, the driveway, and any gates or access limits help us build the quote around the real scope.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Arkadelphia AR, Caddo Valley AR, Bismarck AR, and nearby properties.",
    areaText: "This page is specifically for Arkadelphia, Arkansas and nearby communities including Caddo Valley AR, Bismarck AR, Gurdon AR. Travel and disposal are included when we build the quote.",
    schemaName: "Arkadelphia Property Cleanup",
    schemaDescription: "Property cleanup in Arkadelphia, Arkansas for junk, brush, rental debris, storm mess, neglected lots, and rural properties. Request a local Red Dirt quote.",
    serviceType: ["Rental property cleanup", "Brush and debris removal", "Storm mess cleanup", "Vacant property clearing", "Rural lot cleanup", "Hauling and light demo"],
    areaServed: ["Arkadelphia AR", "Caddo Valley AR", "Bismarck AR", "Gurdon AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Arkadelphia Services", "href": "/arkadelphia-ar", "text": "See the full range of property services available in the area."}],
  },
  "malvern-junk-removal": {
    slug: "malvern-junk-removal",
    title: "Junk Removal in Malvern, AR",
    description: "Junk removal in Malvern, Arkansas for furniture, appliances, garages, rentals, move-outs, and property debris. Red Dirt provides straightforward local quotes.",
    ogTitle: "Junk Removal in Malvern, AR | Red Dirt Property Services LLC",
    ogDescription: "Junk removal in Malvern, Arkansas for furniture, appliances, garages, rentals, move-outs, and property debris. Red Dirt provides straightforward local quotes.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "malvern junk removal work by Red Dirt Property Services LLC",
    eyebrow: "Malvern Junk Removal • Local Quotes • Red Dirt",
    h1: "Get The Junk Loaded And Gone In Malvern.",
    intro: "Red Dirt helps Malvern homeowners, landlords, and property owners remove furniture, appliances, garage piles, rental leftovers, and mixed debris that regular trash service will not handle.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Malvern Junk Removal",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Red Dirt helps Malvern homeowners, landlords, and property owners remove furniture, appliances, garage piles, rental leftovers, and mixed debris that regular trash service will not handle.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Furniture removal", "Appliance haul-off", "Garage junk", "Rental leftovers", "Move-out cleanup", "Mixed debris loads"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for malvern junk removal jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "Photos should show the full pile, heavy items, steps, and how close a trailer can park. Disposal type and travel are part of the quote, so clear information keeps surprises out of the job.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Malvern AR, Rockport AR, Donaldson AR, and nearby properties.",
    areaText: "This page is specifically for Malvern, Arkansas and nearby communities including Rockport AR, Donaldson AR, Magnet Cove AR. Travel and disposal are included when we build the quote.",
    schemaName: "Malvern Junk Removal",
    schemaDescription: "Junk removal in Malvern, Arkansas for furniture, appliances, garages, rentals, move-outs, and property debris. Red Dirt provides straightforward local quotes.",
    serviceType: ["Furniture removal", "Appliance haul-off", "Garage junk", "Rental leftovers", "Move-out cleanup", "Mixed debris loads"],
    areaServed: ["Malvern AR", "Rockport AR", "Donaldson AR", "Magnet Cove AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Malvern Services", "href": "/malvern-ar", "text": "See the full range of property services available in the area."}],
  },
  "malvern-property-cleanup": {
    slug: "malvern-property-cleanup",
    title: "Property Cleanup in Malvern, AR",
    description: "Property cleanup in Malvern, Arkansas for junk, brush, storm debris, neglected yards, rentals, and rural property mess. Call Red Dirt for a quote.",
    ogTitle: "Property Cleanup in Malvern, AR | Red Dirt Property Services LLC",
    ogDescription: "Property cleanup in Malvern, Arkansas for junk, brush, storm debris, neglected yards, rentals, and rural property mess. Call Red Dirt for a quote.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "malvern property cleanup work by Red Dirt Property Services LLC",
    eyebrow: "Malvern Property Cleanup • Local Quotes • Red Dirt",
    h1: "Practical Property Cleanup Around Malvern.",
    intro: "From in-town rentals to rougher property outside Malvern, cleanup jobs can include old junk, limbs, brush, damaged fencing, shed debris, and areas that have been ignored for a while. We look at the whole job and quote what can be handled safely.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Malvern Property Cleanup",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "From in-town rentals to rougher property outside Malvern, cleanup jobs can include old junk, limbs, brush, damaged fencing, shed debris, and areas that have been ignored for a while. We look at the whole job and quote what can be handled safely.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Rental cleanup", "Brush and limb removal", "Vacant property cleanup", "Storm debris", "Shed and fence debris", "Combined cleanup and hauling"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for malvern property cleanup jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "Wide photos help us understand whether the job is a single trailer load or a multi-step cleanup. Include access, terrain, and anything hidden under brush or mixed into the pile.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Malvern AR, Rockport AR, Donaldson AR, and nearby properties.",
    areaText: "This page is specifically for Malvern, Arkansas and nearby communities including Rockport AR, Donaldson AR, Magnet Cove AR. Travel and disposal are included when we build the quote.",
    schemaName: "Malvern Property Cleanup",
    schemaDescription: "Property cleanup in Malvern, Arkansas for junk, brush, storm debris, neglected yards, rentals, and rural property mess. Call Red Dirt for a quote.",
    serviceType: ["Rental cleanup", "Brush and limb removal", "Vacant property cleanup", "Storm debris", "Shed and fence debris", "Combined cleanup and hauling"],
    areaServed: ["Malvern AR", "Rockport AR", "Donaldson AR", "Magnet Cove AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Malvern Services", "href": "/malvern-ar", "text": "See the full range of property services available in the area."}],
  },
  "mount-ida-property-cleanup": {
    slug: "mount-ida-property-cleanup",
    title: "Property Cleanup in Mount Ida, AR",
    description: "Property cleanup in Mount Ida, Arkansas for cabins, lake properties, rural acreage, junk, brush, storm debris, and outbuildings. Local Red Dirt quotes.",
    ogTitle: "Property Cleanup in Mount Ida, AR | Red Dirt Property Services LLC",
    ogDescription: "Property cleanup in Mount Ida, Arkansas for cabins, lake properties, rural acreage, junk, brush, storm debris, and outbuildings. Local Red Dirt quotes.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "mount ida property cleanup work by Red Dirt Property Services LLC",
    eyebrow: "Mount Ida Property Cleanup • Local Quotes • Red Dirt",
    h1: "Cleanup For Mount Ida Cabins, Acreage, And Country Places.",
    intro: "Mount Ida cleanup work often involves cabins, lake-area properties, wooded lots, family land, and places that sit empty part of the year. Red Dirt helps remove junk, brush, limbs, old materials, and other property mess when the job fits.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Mount Ida Property Cleanup",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Mount Ida cleanup work often involves cabins, lake-area properties, wooded lots, family land, and places that sit empty part of the year. Red Dirt helps remove junk, brush, limbs, old materials, and other property mess when the job fits.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Cabin property cleanup", "Lake-area junk hauling", "Brush and limb piles", "Outbuilding cleanup", "Storm debris removal", "Rural acreage cleanup"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for mount ida property cleanup jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "Narrow roads, steep drives, gates, and distance from disposal can matter around Mount Ida. Send photos of the work and the access route so we can tell whether the truck, trailer, and equipment can reach it safely.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Mount Ida AR, Norman AR, Story AR, and nearby properties.",
    areaText: "This page is specifically for Mount Ida, Arkansas and nearby communities including Norman AR, Story AR, Pencil Bluff AR. Travel and disposal are included when we build the quote.",
    schemaName: "Mount Ida Property Cleanup",
    schemaDescription: "Property cleanup in Mount Ida, Arkansas for cabins, lake properties, rural acreage, junk, brush, storm debris, and outbuildings. Local Red Dirt quotes.",
    serviceType: ["Cabin property cleanup", "Lake-area junk hauling", "Brush and limb piles", "Outbuilding cleanup", "Storm debris removal", "Rural acreage cleanup"],
    areaServed: ["Mount Ida AR", "Norman AR", "Story AR", "Pencil Bluff AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Mount Ida Services", "href": "/mount-ida-ar", "text": "See the full range of property services available in the area."}],
  },
  "mount-ida-brush-hogging": {
    slug: "mount-ida-brush-hogging",
    title: "Brush Hogging in Mount Ida, AR",
    description: "Brush hogging and bush hogging in Mount Ida, Arkansas for rural acreage, cabin lots, trails, field edges, and overgrown property. Photo-based quotes available.",
    ogTitle: "Brush Hogging in Mount Ida, AR | Red Dirt Property Services LLC",
    ogDescription: "Brush hogging and bush hogging in Mount Ida, Arkansas for rural acreage, cabin lots, trails, field edges, and overgrown property. Photo-based quotes available.",
    heroImage: "/images/tractor-bush-hog.jpg",
    heroAlt: "mount ida brush hogging work by Red Dirt Property Services LLC",
    eyebrow: "Mount Ida Brush Hogging • Local Quotes • Red Dirt",
    h1: "Open Up Overgrown Ground Around Mount Ida.",
    intro: "Brush hogging around Mount Ida is rarely a flat, empty pasture. Cabin lots, wooded edges, trails, slopes, rocks, and hidden debris all have to be considered before equipment goes in.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Mount Ida Brush Hogging",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Brush hogging around Mount Ida is rarely a flat, empty pasture. Cabin lots, wooded edges, trails, slopes, rocks, and hidden debris all have to be considered before equipment goes in.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Cabin lot mowing", "Trail opening", "Field-edge cutting", "Rural acreage mowing", "Fence-line brush work", "Overgrowth reduction"],
    detailImage: "/images/tractor-pov.jpg",
    detailAlt: "Red Dirt equipment used for mount ida brush hogging jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "We quote acreage only after looking at terrain and obstacles. Clear photos, approximate acreage, and notes about rocks, wire, stumps, wet areas, or steep ground help us decide what is workable.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Mount Ida AR, Norman AR, Story AR, and nearby properties.",
    areaText: "This page is specifically for Mount Ida, Arkansas and nearby communities including Norman AR, Story AR, Pencil Bluff AR. Travel and disposal are included when we build the quote.",
    schemaName: "Mount Ida Brush Hogging",
    schemaDescription: "Brush hogging and bush hogging in Mount Ida, Arkansas for rural acreage, cabin lots, trails, field edges, and overgrown property. Photo-based quotes available.",
    serviceType: ["Cabin lot mowing", "Trail opening", "Field-edge cutting", "Rural acreage mowing", "Fence-line brush work", "Overgrowth reduction"],
    areaServed: ["Mount Ida AR", "Norman AR", "Story AR", "Pencil Bluff AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Mount Ida Services", "href": "/mount-ida-ar", "text": "See the full range of property services available in the area."}],
  },
  "amity-brush-hogging": {
    slug: "amity-brush-hogging",
    title: "Brush Hogging in Amity, AR",
    description: "Brush hogging and bush hogging in Amity, Arkansas for fields, lots, trails, fence lines, and rural acreage. Local Red Dirt service with photo-based quotes.",
    ogTitle: "Brush Hogging in Amity, AR | Red Dirt Property Services LLC",
    ogDescription: "Brush hogging and bush hogging in Amity, Arkansas for fields, lots, trails, fence lines, and rural acreage. Local Red Dirt service with photo-based quotes.",
    heroImage: "/images/tractor-bush-hog.jpg",
    heroAlt: "amity brush hogging work by Red Dirt Property Services LLC",
    eyebrow: "Amity Brush Hogging • Local Quotes • Red Dirt",
    h1: "Local Brush Hogging Around Amity.",
    intro: "Red Dirt is based around Amity and handles rough mowing for fields, lot edges, trails, fence lines, and country places that have grown past what a regular mower can handle.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Amity Brush Hogging",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Red Dirt is based around Amity and handles rough mowing for fields, lot edges, trails, fence lines, and country places that have grown past what a regular mower can handle.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Field cutting", "Trail opening", "Fence-line mowing", "Lot cleanup mowing", "Small acreage cutting", "Brush reduction"],
    detailImage: "/images/tractor-pov.jpg",
    detailAlt: "Red Dirt equipment used for amity brush hogging jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "Because we are local, Amity jobs can often be looked at without building in long travel. We still need to see rocks, wire, slopes, wet ground, and hidden debris before confirming the work.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Amity AR, Glenwood AR, Point Cedar AR, and nearby properties.",
    areaText: "This page is specifically for Amity, Arkansas and nearby communities including Glenwood AR, Point Cedar AR, Alpine AR. Travel and disposal are included when we build the quote.",
    schemaName: "Amity Brush Hogging",
    schemaDescription: "Brush hogging and bush hogging in Amity, Arkansas for fields, lots, trails, fence lines, and rural acreage. Local Red Dirt service with photo-based quotes.",
    serviceType: ["Field cutting", "Trail opening", "Fence-line mowing", "Lot cleanup mowing", "Small acreage cutting", "Brush reduction"],
    areaServed: ["Amity AR", "Glenwood AR", "Point Cedar AR", "Alpine AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Amity Services", "href": "/amity-ar", "text": "See the full range of property services available in the area."}],
  },
  "amity-property-cleanup": {
    slug: "amity-property-cleanup",
    title: "Property Cleanup in Amity, AR",
    description: "Property cleanup in Amity, Arkansas for junk, brush, storm limbs, rural lots, sheds, and family properties. Local hauling and cleanup from Red Dirt.",
    ogTitle: "Property Cleanup in Amity, AR | Red Dirt Property Services LLC",
    ogDescription: "Property cleanup in Amity, Arkansas for junk, brush, storm limbs, rural lots, sheds, and family properties. Local hauling and cleanup from Red Dirt.",
    heroImage: "/images/work-1.jpg",
    heroAlt: "amity property cleanup work by Red Dirt Property Services LLC",
    eyebrow: "Amity Property Cleanup • Local Quotes • Red Dirt",
    h1: "Local Cleanup Help For Amity Properties.",
    intro: "Around Amity, property cleanup is often personal: a family place, an old home site, acreage that needs opened up, a shed full of years of stuff, or storm debris that never got finished. Red Dirt handles the work with local knowledge and straightforward quoting.",
    primaryCta: "Call or Text Photos",
    secondaryCta: "Request a Local Quote",
    overviewEyebrow: "Amity Property Cleanup",
    overviewTitle: "Work quoted around the actual property, not a generic online price.",
    overviewText: [
      "Around Amity, property cleanup is often personal: a family place, an old home site, acreage that needs opened up, a shed full of years of stuff, or storm debris that never got finished. Red Dirt handles the work with local knowledge and straightforward quoting.",
      "Every job is quoted around load size, labor, equipment, disposal, travel, and access. That matters on rural lanes, rental properties, lake places, and jobs where several kinds of cleanup overlap.",
      "Red Dirt is a small local operation. We tell you what fits our equipment, what information we need, and what the job should take before scheduling the work."
    ],
    cards: ["Rural property cleanup", "Family property clearing", "Brush and limb removal", "Shed and outbuilding cleanup", "Junk and debris hauling", "Storm cleanup"],
    detailImage: "/images/truck-trailers.jpg",
    detailAlt: "Red Dirt equipment used for amity property cleanup jobs",
    detailEyebrow: "Before We Quote",
    detailTitle: "Photos, access, and the real scope matter.",
    detailText: [
      "We can often start with photos, but larger Amity jobs may be worth looking at in person. Show every work area and explain what should stay, what should be cut, and what needs hauled away.",
      "Include the property location, a wide view of the work, close photos of heavy or difficult material, and any gates, stairs, slopes, soft ground, or tight turns.",
      "Once we can see the job clearly, we can give you a practical next step instead of an estimate built on missing information."
    ],
    areaTitle: "Serving Amity AR, Glenwood AR, Point Cedar AR, and nearby properties.",
    areaText: "This page is specifically for Amity, Arkansas and nearby communities including Glenwood AR, Point Cedar AR, Alpine AR. Travel and disposal are included when we build the quote.",
    schemaName: "Amity Property Cleanup",
    schemaDescription: "Property cleanup in Amity, Arkansas for junk, brush, storm limbs, rural lots, sheds, and family properties. Local hauling and cleanup from Red Dirt.",
    serviceType: ["Rural property cleanup", "Family property clearing", "Brush and limb removal", "Shed and outbuilding cleanup", "Junk and debris hauling", "Storm cleanup"],
    areaServed: ["Amity AR", "Glenwood AR", "Point Cedar AR", "Alpine AR"],
    related: [{"label": "Property Cleanup", "href": "/property-cleanup", "text": "Brush, junk, debris, neglected yards, and rough property cleanup."}, {"label": "Junk Removal", "href": "/junk-removal", "text": "Furniture, appliances, debris, garage junk, and haul-off work."}, {"label": "Amity Services", "href": "/amity-ar", "text": "See the full range of property services available in the area."}],
  },
...
export const locationPages: Record<string, LocationPageData> = {
  "amity-ar": {
    ...
    description:
      "Red Dirt Property Services LLC is local to the Amity, Arkansas area and handles property cleanup, junk removal, hauling, bush hogging, cleanouts, storm cleanup, and light demolition for nearby rural properties.",
    ogTitle: "Property Cleanup & Brush Hogging in Amity AR | Red Dirt",
    ogDescription:
      "Local Amity property cleanup, junk removal, hauling, bush hogging, cleanouts, storm cleanup, and light demolition from Red Dirt Property Services LLC.",
    heroImage: "/images/hero.jpg",
    heroAlt: "Red Dirt Property Services LLC work around Amity Arkansas",
